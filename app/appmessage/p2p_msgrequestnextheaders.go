...
// MsgRequestNextHeaders implements the Message interface and represents a sera
...
// NewMsgRequestNextHeaders returns a new sera RequestNextHeaders message that conforms to the
// Message interface.
