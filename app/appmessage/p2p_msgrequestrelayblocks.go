...
// MsgRequestRelayBlocks implements the Message interface and represents a sera
...
// NewMsgRequestRelayBlocks returns a new sera RequestRelayBlocks message that conforms to
