...
// MsgRequestTransactions implements the Message interface and represents a sera
...
// NewMsgRequestTransactions returns a new sera RequestTransactions message that conforms to
