...
// MsgRequestHeaders implements the Message interface and represents a sera
...
// NewMsgRequstHeaders returns a new sera RequestHeaders message that conforms to the
