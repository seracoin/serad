...
// RPCTransaction is a serad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a serad transaction input representation
...
// RPCScriptPublicKey is a serad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a serad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a serad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a serad utxo entry representation meant to be used
// over RPC
