...
// MsgRequestAnticone implements the Message interface and represents a sera
...
// NewMsgRequestAnticone returns a new sera RequestPastDiff message that conforms to the
