...
// MsgTransactionNotFound defines a sera TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new sera transactionsnotfound message that conforms to the
