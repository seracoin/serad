...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := serad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = serad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = serad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
