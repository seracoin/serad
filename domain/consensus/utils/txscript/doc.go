/*
Package txscript implements the sera transaction script language.

This package provides data structures and functions to parse and execute
sera transaction scripts.

# Script Overview

sera transaction scripts are written in a stack-base, FORTH-like language.

The sera script language consists of a number of opcodes which fall into
...
Typical sera scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend sera.
