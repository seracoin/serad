...
// installService attempts to install the Serad Service. Typically this should
...
// removeService attempts to uninstall the Serad Service. Typically this should
...
// startService attempts to Start the Serad Service.
