...
type GetBlockTemplateRequestMessage struct {
	...
	// Which sera address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether serad thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when serad is not synced.
	// That is because when serad isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this serad initiated the connection
	...
	// The timestamp of when this peer connected to this serad
