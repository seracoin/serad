...
type P2P_MessageStreamClient interface {
	Send(*SeradMessage) error
	Recv() (*SeradMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SeradMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SeradMessage, error) {
	m := new(SeradMessage)
...
func (x *p2PMessageStreamServer) Send(m *SeradMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SeradMessage, error) {
	m := new(SeradMessage)
...
func (x *rPCMessageStreamClient) Send(m *SeradMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SeradMessage, error) {
	m := new(SeradMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SeradMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SeradMessage, error) {
	m := new(SeradMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
